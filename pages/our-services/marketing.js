  ...
  return (
    <div className="mx-auto max-w-7xl">
      <section className="mt-3">
        <h1>{t('common:Marketing')}</h1>

        <div className="grid grid-cols-3 pt-4 md:mx-6 lg:mx-12">
          <div className="col-span-3 mb-12 sm:col-span-1 md:mb-4">
            <ConsultantOnly Theme="marketing" />
          </div>

          <div className="col-span-3 mb-4 sm:col-span-2">
            <p className="PageText">{t('marketing.content.1')} </p>
            <p className="PageText">{t('marketing.content.2')} </p>
            <p className="PageText">{t('marketing.content.3')} </p>
            <div className="mt-1 flex flex-wrap">
              {sectorFocus.marketing.map((hashtag) => (
...
marketing.getLayout = function getLayout(page) {
  ...
  return (
    <Layout
      headContent={
        <Head>
          <title>OCG - Marketing</title>
          <meta name="description" content="OCG - Marketing" />
        </Head>
      }
    >
      <LayoutPage title={t('Specialization')} subtitle={t('Marketing')}>
        {page}
      </LayoutPage>
    </Layout>
  )
